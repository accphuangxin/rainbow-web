    ...
    MMPaginator.prototype = {
        _initLayout: function(){
            ...
            $limitList.on('change', function(){
                $el.data('page', 1);
                that.$mmGrid.load(serializeObject($('#'+opts.queryform)));
            });

        }

        , _plain: function(page, totalCount, limit,queryform){
            var that = this;
            var $el = this.$el;
            ...
            if(page<=1){
                ...
                $prev.find('a').on('click', function(){
                    $el.data('page', page-1);
                    that.$mmGrid.load(serializeObject($('#'+queryform)));
                });
            }
        ...
        , load: function(params,queryform){
            var $el = this.$el;
            var $limitList = this.$limitList;
            var opts = this.opts;
            ...
            this._plain(page, totalCount, this.$limitList.val(),queryform);
        }
        ...
        , init: function($grid){
            ...
            this.load(params,opts.queryform);
